...
const sections = [
  { id: 'san', label: 'Standard Algebraic (SAN)' },
  { id: 'short', label: 'Short Notation' },
  { id: 'conversion', label: 'Conversion rule' },
  { id: 'invalid', label: 'Invalid mixed forms' },
  { id: 'valid', label: 'Valid forms' },
  { id: 'disambiguation', label: 'Disambiguation' },
  { id: 'letters', label: 'English piece letters' },
  ...
  return (
    <DocLayout sections={sections}>
      <header className="mb-8 border-b border-[color:var(--paper-rule)] pb-6">
        ...
        <Para>
          The keyboard input accepts two notation styles. Anything else — including mixed
          forms or non-English piece letters — will be rejected as an invalid move.
        </Para>
      </header>
      ...
      <h2 id="san" className="mt-10 mb-4 scroll-mt-20 font-display text-xl font-semibold tracking-[-0.01em] text-[color:var(--ink)] md:text-2xl">
        Standard Algebraic Notation (SAN)
      </h2>
      <Para>
        The conventional notation used in books, databases, and tournament records.
      </Para>
      <h3 className="mt-6 mb-3 text-[15px] font-semibold text-[color:var(--ink)]">Examples</h3>
      <List
        items={[
          <Code key="1">Rxb7+</Code>,
          <Code key="2">gxf7+</Code>,
          <Code key="3">Qh5#</Code>,
          <Code key="4">Nf3</Code>,
        ]}
      />
      <h3 className="mt-6 mb-3 text-[15px] font-semibold text-[color:var(--ink)]">Features</h3>
      <List
        items={[
      ...
      />
      <h3 className="mt-6 mb-3 text-[15px] font-semibold text-[color:var(--ink)]">Disambiguation examples</h3>
      <List
        items={[
      ...
      <h2 id="short" className="mt-10 mb-4 scroll-mt-20 font-display text-xl font-semibold tracking-[-0.01em] text-[color:var(--ink)] md:text-2xl">
        Short Notation
      </h2>
      <Para>A compact notation designed to reduce the number of characters.</Para>
      <h3 className="mt-6 mb-3 text-[15px] font-semibold text-[color:var(--ink)]">Rules</h3>
      <List
        items={[
      ...
      <ComparisonTable
        ...
        rows={[
          [<Code key="a">Rxb7+</Code>, <Code key="b">Rb7</Code>],
          [<Code key="a">Rxb7#</Code>, <Code key="b">Rb7</Code>],
          [<Code key="a">gxf7+</Code>, <Code key="b">gf</Code>],
          [<Code key="a">gxh8=Q#</Code>, <Code key="b">gh=Q</Code>],
          [<Code key="a">Nf3</Code>, <Code key="b">Nf3</Code>],
          [<Code key="a">Nbd2</Code>, <Code key="b">Nbd2</Code>],
          [<Code key="a">R1e1+</Code>, <Code key="b">R1e1</Code>],
        ]}
      />

      <h2 id="conversion" className="mt-10 mb-4 scroll-mt-20 font-display text-xl font-semibold tracking-[-0.01em] text-[color:var(--ink)] md:text-2xl">
        Conversion rule
      </h2>
      ...
      <List
        items={[
          ...
          <><strong>Short Notation</strong> — omits <Code>x</Code>, <Code>+</Code>, and <Code>#</Code> together.</>,
        ]}
      />
      <Para>
      ...
      <h2 id="invalid" className="mt-10 mb-4 scroll-mt-20 font-display text-xl font-semibold tracking-[-0.01em] text-[color:var(--ink)] md:text-2xl">
        Invalid mixed forms
      </h2>
      <List
        items={[
      ...
      <h2 id="valid" className="mt-10 mb-4 scroll-mt-20 font-display text-xl font-semibold tracking-[-0.01em] text-[color:var(--ink)] md:text-2xl">
        Valid forms
      </h2>
      <List
        items={[
      ...
      <h2 id="disambiguation" className="mt-10 mb-4 scroll-mt-20 font-display text-xl font-semibold tracking-[-0.01em] text-[color:var(--ink)] md:text-2xl">
      ...
      <h2 id="letters" className="mt-10 mb-4 scroll-mt-20 font-display text-xl font-semibold tracking-[-0.01em] text-[color:var(--ink)] md:text-2xl">
      ...
      <h2 id="summary" className="mt-10 mb-4 scroll-mt-20 font-display text-xl font-semibold tracking-[-0.01em] text-[color:var(--ink)] md:text-2xl">
        Summary
      </h2>
      <List
        items={[
          <><strong>SAN</strong> — full conventional notation.</>,
          <><strong>Short Notation</strong> — all optional symbols (<Code>x</Code>, <Code>+</Code>, <Code>#</Code>) omitted together.</>,
